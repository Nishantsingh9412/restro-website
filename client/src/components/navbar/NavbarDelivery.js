...
import DeliveryNavbarLinks from "components/navbar/NavbarLinksDelivery";
import { SidebarResponsive } from "components/sidebar/Sidebar";
import { deliveryRoutes } from "routes";

export default function DeliveryNavbar(props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <SidebarResponsive routes={deliveryRoutes} />
      </Flex>
      <Flex
        w="100%"
        flexDirection={{
