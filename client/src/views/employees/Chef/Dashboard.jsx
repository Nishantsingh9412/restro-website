...
export default function ChefDashboard() {
  ...
  const data = useSelector((state) => state.chef.dashboardData);
  const dispatch = useDispatch();

  const handleRefresh = useCallback(() => {
    setUtils({ isLoading: true, isError: false });
    dispatch(getChefDashboardDataAction())
  ...
  return (
    <div>
      <Flex
        ...
        mb={5}
      >
        <Heading fontSize={30}>Chef Dashboard</Heading>
        <Button
        ...
        <>
          ...
          >
            <DashboardCard
              ...
              footerLink="/dishes/today"
              color="green"
            />
            <DashboardCard
              title="Monthly Dishes"
