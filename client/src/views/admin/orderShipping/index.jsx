...
import { deleteSingleDelBoyAction, getAllDelboyzAction } from '../../../redux/action/delboy.js';
        ...
        <div style={{ marginTop: '5vw', marginLeft: '4vw' }}>
            ...
            >
                ...
                >
                    ...
                    > Allot Delievery Boy </ModalHeader>
                    <ModalCloseButton />
                    <FormControl>
            ...
            <SimpleGrid columns={{ sm: 1, md: 2, lg: 3 }} spacing="20px">
                {allDelBoyz.map((boy) => (
                    <Box key={boy?._id} p="5" boxShadow="md" borderWidth="1px" borderRadius="lg" overflow="hidden">
